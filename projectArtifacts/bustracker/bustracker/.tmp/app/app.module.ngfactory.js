...
var AppModuleInjector = (function (_super) {
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_LocationTracker_74", {
        get: function () {
            if ((this.__LocationTracker_74 == null)) {
                (this.__LocationTracker_74 = new import44.LocationTracker(this.parent.get(import60.NgZone), this._Http_50));
            }
    ...
    AppModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === import44.LocationTracker)) {
            return this._LocationTracker_74;
        }
